...
public class FenUtilities {
    ...
    public static String createFENFromGame(final Board board){
        return calculateBoardText(board) + " " + calculateCurrenPlayerText(board) + " " + calculateCastleText(board) + " " + calculateEnPassantSquare(board) + "0-1";
    }
    ...
    private static String calculateCurrenPlayerText(final Board board) {
